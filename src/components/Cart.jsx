        ...
        <div className="container">
            {
                product.map((e, i) => {
                    ...
                    return <>
                        <div className="card mb-5 border border-secondary" style={{ maxWidth: '50%' }} key={i}>
                            <div className="row g-0">
                                <div className="col-md-3">
                                    <img src={e.image} className="img-card img-fluid rounded-start cardImage" alt="..." />
                                </div>
                                <div className="col-md-9">
                                    <div className="card-body px-3">
                                        <div className="top">
                                            <div className="top-header d-flex justify-content-between align-items-center">
                                                <h5 className="hearder card-title">{e.title}</h5>
